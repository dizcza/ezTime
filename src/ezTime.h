...
// ALARM_OFF 7: All disabled � Default value	
	...
	typedef enum {
		SquareWaveDisable = RV3032_DISABLE_CLKOUT,
		SquareWave1Hz     = RV3032_XTAL_1HZ_OUT,
		SquareWave64Hz    = RV3032_XTAL_64HZ_OUT,
		SquareWave1024Hz  = RV3032_XTAL_1024HZ_OUT,
		SquareWave32768Hz = RV3032_XTAL_32KHZ_OUT,
	} SquareWave_t;
